...
if( (exist('zlib.h')))
   ...
   elseif (isequal(computer,'GLNX86')||isequal(computer,'LNX86')||isequal(computer,'x86_64-pc-linux-gnu'))
      ...
      fprintf(1,'deflate_uncompress... ');
      eval(['mex ', compflags, ' deflate_uncompress.c -Ljournaline_20040318/zlib-1.2.1 -lz -D_LINUX_']);
      fprintf(1,'ok\n');
      fprintf(1,'journaline_decode... ');
      [unix_status, unix_result] = unix('make');
      eval(['mex ', compflags, ' journaline_decode.cpp -Lzlib dabdgdec_impl.o newsobject.o newssvcdec_impl.o crc_8_16.o NML.o Splitter.o log.o -lstdc++ -lz -D_LINUX_']);
      fprintf(1,'ok\n');
