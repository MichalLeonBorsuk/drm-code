 ...
 *
\******************************************************************************/
#ifndef _GALOISFIELDELEMENTZERO_H
#define _GALOISFIELDELEMENTZERO_H

#include "GaloisFieldElement.h"

class GaloisFieldElementZero :
	public GaloisFieldElement
{
public:
	GaloisFieldElementZero(const GaloisField *Field);
	virtual ~GaloisFieldElementZero(void);
