...
/* Implementation *************************************************************/
void CAMSSExtractBits::ProcessDataInternal(CParameter& ReceiverParam)
{
	int i;
...
void CAMSSDecode::InitInternal(CParameter& ReceiverParam)
{
	iInputBlockSize = 2;
	...
	bOffsetBlock1[0] = 0; bOffsetBlock1[1] = 1; bOffsetBlock1[2] = 0; bOffsetBlock1[3] = 1;
	bOffsetBlock1[4] = 1; bOffsetBlock1[5] = 0; bOffsetBlock1[6] = 1; bOffsetBlock1[7] = 0;
	bOffsetBlock1[8] = 1; bOffsetBlock1[9] = 0; bOffsetBlock1[10] = 1;

	bOffsetBlock2.Init(AMSS_OFFSET_SIZE_BITS);
	bOffsetBlock2[0] = 1; bOffsetBlock2[1] = 0; bOffsetBlock2[2] = 1; bOffsetBlock2[3] = 1;
	bOffsetBlock2[4] = 0; bOffsetBlock2[5] = 1; bOffsetBlock2[6] = 0; bOffsetBlock2[7] = 1;
	bOffsetBlock2[8] = 0; bOffsetBlock2[9] = 1; bOffsetBlock2[10] = 1;

	bGP.Init(AMSS_GP_SIZE_BITS);
	bGP[0] = 1; bGP[1] = 0; bGP[2] = 0; bGP[3] = 1;
	bGP[4] = 0; bGP[5] = 1; bGP[6] = 0; bGP[7] = 0;
	bGP[8] = 0; bGP[9] = 0; bGP[10] = 0; bGP[11] =1;
...
void CAMSSDecode::ProcessDataInternal(CParameter& ReceiverParam)
{
	...
	for (i = 0; i < iInputBlockSize; i++)
	{
		...
		{
			DecodeBlock(bAMSSBits, ReceiverParam);
	...
	if (iPercentageDataEntityGroupComplete >= 100)
	{
		...
		ReceiverParam.iNumSDCBitsPerSuperFrame = iTotalDataEntityGroupSegments * DATA_ENTITY_GROUP_SEGMENT_SIZE_BITS;
...
int CAMSSDecode::DecodeBlock(CVector<_BINARY>& bBits, CParameter& ReceiverParam)
{
	int i;
...
void CAMSSDecode::ResetStatus(CParameter& ReceiverParam)
{
	int i;
