...
const CellPos iTableFACRobModA[NUM_FAC_CELLS_DRM30] = {
    {2, 26}, {2, 46}, {2, 66}, {2, 86},
...
const CellPos iTableFACRobModB[NUM_FAC_CELLS_DRM30] = {
...
const CellPos iTableFACRobModC[NUM_FAC_CELLS_DRM30] = {
    {3, 9}, {3, 21}, {3, 45}, {3, 57},
    {4, 23}, {4, 35}, {4, 47},
    {5, 13}, {5, 25}, {5, 37}, {5, 49},
    {6, 15}, {6, 27}, {6, 39}, {6, 51},
...
const CellPos iTableFACRobModD[NUM_FAC_CELLS_DRM30] = {
    {3, 9}, {3, 18}, {3, 27},
    {4, 10}, {4, 19},
    {5, 11}, {5, 20}, {5, 29},
    {6, 12}, {6, 30},
...
const CellPos iTableFACRobModE[NUM_FAC_CELLS_DRMPLUS] = {
