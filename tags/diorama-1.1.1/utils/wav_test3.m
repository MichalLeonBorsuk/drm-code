...
% test the resampling inside the record and play routines
...
wavplayex(x,Fs,r_play);
wavplayex(x,Fs,r_play);
y48 = wavrecordex(N_delay, Fs, Ch, r_record );
y48 = wavrecordex(N_fft, Fs, Ch, r_record );
...
wavplayex(x,Fs,r_play);
wavplayex(x,Fs,r_play);
y44 = wavrecordex(N_delay, Fs, Ch, r_record );
y44 = wavrecordex(N_fft, Fs, Ch, r_record );
